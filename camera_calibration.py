...
square_size = 22  # Physical size of the squares (e.g., 1 unit, which could be cm or any unit you choose)
...
images = glob.glob('calibration_images/*.jpg')  # Make sure to have your images in this folder
